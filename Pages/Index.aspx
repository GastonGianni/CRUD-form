                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Opciones del Administrador">
                                <ItemTemplate>
                                    ...
                                    <asp:Button runat="server" Text="Update" CssClass="btn form-control-sm btn-info btn-warning" ID="BtnUpdate" OnClick="BtnUpdate_Click"/>
                                    <asp:Button runat="server" Text="Delete" CssClass="btn form-control-sm btn-info btn-danger" ID="BtnDelete" OnClick="BtnDelete_Click"/>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
